...
ask()/answer() - is doing three different jobs across a session: presenting a
fresh question, re-presenting the same question after a re-explanation, and
asking the "worked example or simpler problem?" pause question. Same code
path every time; only the resume_state differs.
"""
...
def cmd_run(args: argparse.Namespace) -> int:
    ...
    while True:
        ...
        try:
            ...
            print()
            return 130
        callback.answer(store, q.id, answer)
