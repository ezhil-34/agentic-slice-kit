...
AGENT_LABELS = {
    ...
    "agent:custom_check":   ("CUSTOM CHECK", "agent"),   # model-judged, outside the graded flow
    "system":               ("SYSTEM",     "sys"),
...
ERROR_LABELS = {
    "formula_sign_flip": "Sign flip (formula)",
    "formula_forgot_2a": "Forgot 2a (formula)",
    "factor_sign_flip": "Sign flip (factoring)",
    "factor_wrong_pair": "Wrong factor pair",
...
async function tick() {
  ...
  const labels = {formula_sign_flip:"Sign flip (formula)", formula_forgot_2a:"Forgot 2a (formula)",
                  factor_sign_flip:"Sign flip (factoring)", factor_wrong_pair:"Wrong factor pair",
                  unclassified:"Unclassified"};
