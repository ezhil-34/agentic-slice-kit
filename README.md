...
- 🛡️ **Anti-Hallucination & Anti-Leak Guards**: Explanation texts are verified via `leaks_answer()` before presentation to ensure the final roots are never prematurely exposed.
